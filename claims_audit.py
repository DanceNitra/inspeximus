...
NUMBER_CLAIMS = [
    ...
    _c("cc-tool-count", "claude-code.html", ["111"],
       "<h2>111 tools any MCP host can call</h2>",
       "The MCP server exposes 111 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
    ...
    _c("readme-echo-n-and-version", "README.md", ["30", "2.0.11", "2026", "2.0.18"],
       ...
       "REPRODUCIBLE", "curl -s https://pypi.org/pypi/mem0ai/json"),
    _c("readme-mcp-tool-count", "README.md", ["111"],
       "**111 tools**",
       "The MCP server exposes 111 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
       "Checked against the live @mcp.tool() count by _live_consistency(), not read from here."),
    ...
    _c("readme-mcp-tools", "docs/DEEP_DIVE.md", ["111"],
       "`inspeximus-mcp`, 111 tools",
       "The MCP server exposes 111 tools", "REPRODUCIBLE",
       'python -c "import re,pathlib;print(len(re.findall(chr(64)+chr(111)+chr(99)+chr(112)+chr(46)+'
    ...
    # ---------------------------------------------------------- MCP_LISTINGS.md
    _c("mcp-tool-count", "MCP_LISTINGS.md", ["111"],
       "`inspeximus-mcp`, 111 tools",
       "The MCP server exposes 111 tools", "REPRODUCIBLE",
    ...
    _c("mcp-tool-list", "MCP_LISTINGS.md", ["111"],
       "**Tools (111):**",
    ...
    # -------------------------------------------------------------- index.html
    _c("site-mcp-tools-counter", "index.html", ["111", "0"],
       'data-count="111">0</b><span>MCP tools',
       "Homepage counter: 111 MCP tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
    ...
    _c("site-mcp-tools-heading", "index.html", ["111"],
       "111 tools any MCP host can call",
       "Homepage heading: 111 MCP tools", "REPRODUCIBLE", "python claims_audit.py --numbers"),
...
NON_CLAIM_TOKENS = {
    ...
    "README.md": {
        ...
        "5": (2, "twice, both parameters a reader changes rather than results we claim: the --n 5 "
              ...
              "snippet"),
        "0": (15, "15 since 3.0.0: the enable_receipts example reads verify_writes()[1][0], split(':', 1)[0] and verify_writes()[0]. One more [0] in the quickstart snippet on the first screen (2026-09-17). Python list indices [0] in the code examples, not measurements. Was 3 until the "
        ...
        "111,": (1, "the MCP tool count followed by a comma in prose; the claim itself is '73'. "
