...
NUMBER_CLAIMS = [
    ...
    _c("cc-tool-count", "claude-code.html", ["69"],
       "<h2>69 tools any MCP host can call</h2>",
       "The MCP server exposes 69 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
    ...
    _c("readme-echo-n-and-version", "README.md", ["30", "2.0.11", "2026", "2.0.18"],
       ...
       "REPRODUCIBLE", "curl -s https://pypi.org/pypi/mem0ai/json"),
    _c("readme-mcp-tool-count", "README.md", ["69"],
       "**69 tools**",
       "The MCP server exposes 69 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
       "Checked against the live @mcp.tool() count by _live_consistency(), not read from here."),
    ...
    _c("readme-mcp-tools", "docs/DEEP_DIVE.md", ["69"],
       "`inspeximus-mcp`, 69 tools",
       "The MCP server exposes 69 tools", "REPRODUCIBLE",
    ...
    # ---------------------------------------------------------- MCP_LISTINGS.md
    _c("mcp-tool-count", "MCP_LISTINGS.md", ["69"],
       "`inspeximus-mcp`, 69 tools",
       "The MCP server exposes 69 tools", "REPRODUCIBLE",
    ...
    _c("mcp-tool-list", "MCP_LISTINGS.md", ["69"],
       "**Tools (69):**",
    ...
    # -------------------------------------------------------------- index.html
    _c("site-mcp-tools-counter", "index.html", ["69", "0"],
       'data-count="69">0</b><span>MCP tools',
    ...
    _c("site-mcp-tools-heading", "index.html", ["69"],
       "69 tools any MCP host can call",
