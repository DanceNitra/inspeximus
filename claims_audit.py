...
def _prose_number_agrees():
    ...
    So a row could pin `73` and describe it as "The MCP server exposes 82 tools", and pass -- twice,
...
NUMBER_CLAIMS = [
    ...
    _c("cc-tool-count", "claude-code.html", ["82"],
       "<h2>82 tools any MCP host can call</h2>",
       "The MCP server exposes 82 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
    ...
    _c("readme-echo-n-and-version", "README.md", ["30", "2.0.11", "2026", "2.0.18"],
       ...
       "REPRODUCIBLE", "curl -s https://pypi.org/pypi/mem0ai/json"),
    _c("readme-mcp-tool-count", "README.md", ["82"],
       "**82 tools**",
       "The MCP server exposes 82 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
       "Checked against the live @mcp.tool() count by _live_consistency(), not read from here."),
    ...
    _c("readme-compliance-controls", "README.md", ["14"],
       ...
       "REPRODUCIBLE", "python -m pytest tests/test_serious_incidents_carry_the_art_73_clock.py -q",
    ...
    _c("readme-mcp-tools", "docs/DEEP_DIVE.md", ["82"],
       "`inspeximus-mcp`, 82 tools",
       "The MCP server exposes 82 tools", "REPRODUCIBLE",
    ...
    # ---------------------------------------------------------- MCP_LISTINGS.md
    _c("mcp-tool-count", "MCP_LISTINGS.md", ["82"],
       "`inspeximus-mcp`, 82 tools",
       "The MCP server exposes 82 tools", "REPRODUCIBLE",
    ...
    _c("mcp-tool-list", "MCP_LISTINGS.md", ["82"],
       "**Tools (82):**",
    ...
    # -------------------------------------------------------------- index.html
    _c("site-mcp-tools-counter", "index.html", ["82", "0"],
       'data-count="82">0</b><span>MCP tools',
       "Homepage counter: 82 MCP tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
    ...
    _c("site-mcp-tools-heading", "index.html", ["82"],
       "82 tools any MCP host can call",
       "Homepage heading: 82 MCP tools", "REPRODUCIBLE", "python claims_audit.py --numbers"),
...
NON_CLAIM_TOKENS = {
    ...
    "README.md": {
        ...
        "73": (1, "EU AI Act ARTICLE number (serious incidents) in the action-ledger section, not a quantity"),
        "4": (1, "refers_to=[3, 4] in the incident example: a ledger seq number in a code snippet"),
        "82,": (1, "the MCP tool count followed by a comma in prose; the claim itself is '73'. "
