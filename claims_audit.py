...
def _prose_number_agrees():
    ...
    So a row could pin `73` and describe it as "The MCP server exposes 90 tools", and pass -- twice,
...
NUMBER_CLAIMS = [
    ...
    _c("cc-tool-count", "claude-code.html", ["90"],
       "<h2>90 tools any MCP host can call</h2>",
       "The MCP server exposes 90 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
    ...
    _c("readme-echo-n-and-version", "README.md", ["30", "2.0.11", "2026", "2.0.18"],
       ...
       "REPRODUCIBLE", "curl -s https://pypi.org/pypi/mem0ai/json"),
    _c("readme-mcp-tool-count", "README.md", ["90"],
       "**90 tools**",
       "The MCP server exposes 90 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
       "Checked against the live @mcp.tool() count by _live_consistency(), not read from here."),
    ...
    _c("readme-compliance-controls", "README.md", ["21"],
       "into 21 article-labelled",
       "The compliance overlay has twenty-one controls: the seven memory rows, the seven action-ledger rows and "
       "the seven documentation and deployer rows",
    ...
    _c("readme-mcp-tools", "docs/DEEP_DIVE.md", ["90"],
       "`inspeximus-mcp`, 90 tools",
       "The MCP server exposes 90 tools", "REPRODUCIBLE",
    ...
    # ---------------------------------------------------------- MCP_LISTINGS.md
    _c("mcp-tool-count", "MCP_LISTINGS.md", ["90"],
       "`inspeximus-mcp`, 90 tools",
       "The MCP server exposes 90 tools", "REPRODUCIBLE",
    ...
    _c("mcp-tool-list", "MCP_LISTINGS.md", ["90"],
       "**Tools (90):**",
    ...
    # -------------------------------------------------------------- index.html
    _c("site-mcp-tools-counter", "index.html", ["90", "0"],
       'data-count="90">0</b><span>MCP tools',
       "Homepage counter: 90 MCP tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
    ...
    _c("site-mcp-tools-heading", "index.html", ["90"],
       "90 tools any MCP host can call",
       "Homepage heading: 90 MCP tools", "REPRODUCIBLE", "python claims_audit.py --numbers"),
...
NON_CLAIM_TOKENS = {
    ...
    "README.md": {
        ...
        "3": (1, "the paragraph digit in Art. 13(3)(f), not a quantity"),
        ...
        "90,": (1, "the MCP tool count followed by a comma in prose; the claim itself is '73'. "
