...
def _prose_number_agrees():
    ...
    So a row could pin `73` and describe it as "The MCP server exposes 91 tools", and pass -- twice,
...
NUMBER_CLAIMS = [
    ...
    _c("cc-tool-count", "claude-code.html", ["91"],
       "<h2>91 tools any MCP host can call</h2>",
       "The MCP server exposes 91 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
    ...
    _c("readme-echo-n-and-version", "README.md", ["30", "2.0.11", "2026", "2.0.18"],
       ...
       "REPRODUCIBLE", "curl -s https://pypi.org/pypi/mem0ai/json"),
    _c("readme-mcp-tool-count", "README.md", ["91"],
       "**91 tools**",
       "The MCP server exposes 91 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
       "Checked against the live @mcp.tool() count by _live_consistency(), not read from here."),
    ...
    _c("readme-mcp-tools", "docs/DEEP_DIVE.md", ["91"],
       "`inspeximus-mcp`, 91 tools",
       "The MCP server exposes 91 tools", "REPRODUCIBLE",
    ...
    # ---------------------------------------------------------- MCP_LISTINGS.md
    _c("mcp-tool-count", "MCP_LISTINGS.md", ["91"],
       "`inspeximus-mcp`, 91 tools",
       "The MCP server exposes 91 tools", "REPRODUCIBLE",
    ...
    _c("mcp-tool-list", "MCP_LISTINGS.md", ["91"],
       "**Tools (91):**",
    ...
    # -------------------------------------------------------------- index.html
    _c("site-mcp-tools-counter", "index.html", ["91", "0"],
       'data-count="91">0</b><span>MCP tools',
       "Homepage counter: 91 MCP tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
    ...
    _c("site-mcp-tools-heading", "index.html", ["91"],
       "91 tools any MCP host can call",
       "Homepage heading: 91 MCP tools", "REPRODUCIBLE", "python claims_audit.py --numbers"),
...
NON_CLAIM_TOKENS = {
    ...
    "README.md": {
        ...
        "91,": (1, "the MCP tool count followed by a comma in prose; the claim itself is '73'. "
