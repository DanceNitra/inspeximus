...
NUMBER_CLAIMS = [
    ...
    _c("cc-tool-count", "claude-code.html", ["98"],
       "<h2>98 tools any MCP host can call</h2>",
       "The MCP server exposes 98 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
    ...
    _c("readme-echo-n-and-version", "README.md", ["30", "2.0.11", "2026", "2.0.18"],
       ...
       "REPRODUCIBLE", "curl -s https://pypi.org/pypi/mem0ai/json"),
    _c("readme-mcp-tool-count", "README.md", ["98"],
       "**98 tools**",
       "The MCP server exposes 98 tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
       "Checked against the live @mcp.tool() count by _live_consistency(), not read from here."),
    ...
    _c("readme-mcp-tools", "docs/DEEP_DIVE.md", ["98"],
       "`inspeximus-mcp`, 98 tools",
       "The MCP server exposes 98 tools", "REPRODUCIBLE",
    ...
    # ---------------------------------------------------------- MCP_LISTINGS.md
    _c("mcp-tool-count", "MCP_LISTINGS.md", ["98"],
       "`inspeximus-mcp`, 98 tools",
       "The MCP server exposes 98 tools", "REPRODUCIBLE",
    ...
    _c("mcp-tool-list", "MCP_LISTINGS.md", ["98"],
       "**Tools (98):**",
    ...
    # -------------------------------------------------------------- index.html
    _c("site-mcp-tools-counter", "index.html", ["98", "0"],
       'data-count="98">0</b><span>MCP tools',
       "Homepage counter: 98 MCP tools", "REPRODUCIBLE", "python claims_audit.py --numbers",
    ...
    _c("site-mcp-tools-heading", "index.html", ["98"],
       "98 tools any MCP host can call",
       "Homepage heading: 98 MCP tools", "REPRODUCIBLE", "python claims_audit.py --numbers"),
...
NON_CLAIM_TOKENS = {
    ...
    "README.md": {
        ...
        "98,": (1, "the MCP tool count followed by a comma in prose; the claim itself is '73'. "
