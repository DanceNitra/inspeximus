...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 80 tools). Registry manifest:
...
**Tools (80):** provenance and verification first, because that is what people ask for; the ordinary
