...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 109 tools). Registry manifest:
...
**Tools (109):** provenance and verification first, because that is what people ask for; the ordinary
