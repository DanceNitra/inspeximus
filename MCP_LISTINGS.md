...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 111 tools). Registry manifest:
...
**Tools (111):** provenance and verification first, because that is what people ask for; the ordinary
