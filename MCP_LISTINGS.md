...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 84 tools). Registry manifest:
...
**Tools (84):** provenance and verification first, because that is what people ask for; the ordinary
