...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 82 tools). Registry manifest:
...
**Tools (82):** provenance and verification first, because that is what people ask for; the ordinary
