...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 89 tools). Registry manifest:
...
**Tools (89):** provenance and verification first, because that is what people ask for; the ordinary
