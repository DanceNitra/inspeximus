...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 83 tools). Registry manifest:
...
**Tools (83):** provenance and verification first, because that is what people ask for; the ordinary
