...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 99 tools). Registry manifest:
...
**Tools (99):** provenance and verification first, because that is what people ask for; the ordinary
