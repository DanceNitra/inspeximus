...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 69 tools). Registry manifest:
...
**Tools (69):** provenance and verification first, because that is what people ask for; the ordinary
