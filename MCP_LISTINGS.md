...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 112 tools). Registry manifest:
...
**Tools (112):** provenance and verification first, because that is what people ask for; the ordinary
