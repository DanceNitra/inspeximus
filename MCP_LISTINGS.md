...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 121 tools). Registry manifest:
...
**Tools (121):** provenance and verification first, because that is what people ask for; the ordinary
