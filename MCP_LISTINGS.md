...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 78 tools). Registry manifest:
...
**Tools (78):** provenance and verification first, because that is what people ask for; the ordinary
