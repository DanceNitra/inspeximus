...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 88 tools). Registry manifest:
...
**Tools (88):** provenance and verification first, because that is what people ask for; the ordinary
