...
OBLIGATIONS: list[dict[str, Any]] = [
    ...
    {"id": "aia-10", "law": "AI Act", "article": "Art. 10", "duty": "data governance of the training, validation and testing data sets of a system that trains models",
     "who": "provider", "probe": _p_sources, "artifact": "provenance(), pii_report(), retention(); per-record source and lineage",
     "boundary": "Art. 10(1) governs the training, validation and testing data sets of high-risk systems that train AI models. inspeximus trains no model; its provenance, PII and retention reports are evidence here only where memory records are used in such a data set"},
    ...
    {"id": "aia-14", "law": "AI Act", "article": "Art. 14", "duty": "human oversight: disregard, override or reverse an output (14(4)(d)); intervene or stop the system (14(4)(e))", "who": "provider, deployer",
     "probe": _p_oversight, "artifact": "record_oversight(): approve, refuse, override, stop, review",
     "boundary": "the oversight itself is done by natural persons with the interface the provider builds (14(1)). The ledger records each decision they took and who took it"},
    ...
    {"id": "gdpr-21", "law": "GDPR", "article": "Art. 21", "duty": "objection: no further processing unless the controller demonstrates compelling legitimate grounds, or for legal claims", "who": "controller",
     ...
     "boundary": "whether compelling legitimate grounds override the objection is the controller's decision. The ledger records the objection and how it was resolved"},
    {"id": "gdpr-22", "law": "GDPR", "article": "Art. 22", "duty": "the right not to be subject to a decision based solely on automated processing (22(1)); where 22(2)(a) or (c) allows one, at least human intervention, the subject's view and contest (22(3))", "who": "controller",
     "probe": _p_oversight, "artifact": "record_oversight(review) on the action",
     "boundary": "whether a decision is based solely on automated processing, and whether an exception of 22(2) applies, is the controller's assessment. The ledger records the human intervention of 22(3) when it happens"},
