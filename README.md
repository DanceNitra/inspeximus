...
Both wire an MCP server with **82 tools** and the same hooks. From the next session on, your agent starts
...
| [MCP tools](MCP_LISTINGS.md) | all 82, and what each is for |
