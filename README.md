...
Both wire an MCP server with **128 tools** and the same hooks. From the next session on, your agent starts
...
| [MCP tools](MCP_LISTINGS.md) | all 128, and what each is for |
