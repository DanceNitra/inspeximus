...
Both wire an MCP server with **130 tools** and the same hooks. From the next session on, your agent starts
...
| [MCP tools](MCP_LISTINGS.md) | all 130, and what each is for |
