...
| AI Act | Art. 43, 47, 48 | conformity assessment, EU declaration of conformity, CE marking | provider | CAPABILITY | record_declaration() with the Annex V items, the Art. 43 procedure and the Art. 48 marking; declaration_document(seq); scope: the conformity assessment itself is carried out by the provider or a notified body. The ledger holds the declaration drawn up from it, which is the evidence side of this duty. This is a statement of who does what, not a gap in the library |
