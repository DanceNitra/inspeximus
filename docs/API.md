...
Oversight and disclosure share the chain:

```python
led.oversight("override", actor="ops-lead", refers_to=3, reason="manual transfer", decision={"amt": 5})
led.oversight("stop", actor="ops-lead", reason="incident 17")          # events: approve refuse override stop review
led.disclosure("s1", "You are chatting with an AI assistant.", channel="web")   # Art. 50(1)
led.disclosure("s1", "Generated by an AI system.", kind="generated_content")    # Art. 50(2)
led.oversight_report()   # by event, by actor, error actions with no oversight, sessions disclosed
```
