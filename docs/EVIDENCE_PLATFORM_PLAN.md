...
| Art. 13: instructions for use, including how to collect and interpret logs | provider | generated "instructions for use" section describing the ledger schema and the verifier | build |
...
| Art. 11 and Annex IV: technical documentation | provider | **Annex IV generator**: fills the sections that evidence can fill (2(a) to 2(g), 3, 4, 5) from the ledgers and reports, marks the rest as operator input | build (free skeleton, pro dossier) |
