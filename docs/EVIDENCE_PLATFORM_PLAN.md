...
25 of 36 in-scope duties covered by the library, 11 not covered, 2 not applicable. `inspeximus coverage` prints the same matrix for a real store, with EVIDENCE counts.
