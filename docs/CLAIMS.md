...
- **486** numeric tokens are published across the 7 enforced files: README.md, docs/DEEP_DIVE.md, MCP_LISTINGS.md, index.html, compare.html, claude-code.html, quickstart.html.
...
- The other 240 tokens are declared non-claims — citation years,
...
| 2 | `MCP_LISTINGS.md` | `92` | The MCP server exposes 92 tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
| 3 | `MCP_LISTINGS.md` | `92` | The enumerated tool list matches the server | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
...
| 7 | `README.md` | `21` | The compliance overlay has twenty-one controls: the seven memory rows, the seven action-ledger rows and the seven documentation and deployer rows | **REPRODUCIBLE** | `python probes/what_the_agent_knew_when_it_acted.py` |
...
| 20 | `README.md` | `92` | The MCP server exposes 92 tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
...
| 33 | `claude-code.html` | `92` | The MCP server exposes 92 tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
...
| 65 | `docs/DEEP_DIVE.md` | `92` | The MCP server exposes 92 tools | **REPRODUCIBLE** | `python -c "import re,pathlib;print(len(re.findall(chr(64)+chr(109)+chr(99)+chr(112)+chr(46)+'tool', pathlib.Path('inspeximus/mcp_server.py').read_text(encoding='utf-8'))))"` |
...
| 112 | `index.html` | `92` `0` | Homepage counter: 92 MCP tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
| 113 | `index.html` | `92` | Homepage heading: 92 MCP tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
