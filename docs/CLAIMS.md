...
- **573** numeric tokens are published across the 9 enforced files: README.md, docs/DEEP_DIVE.md, MCP_LISTINGS.md, index.html, compare.html, claude-code.html, quickstart.html, erasure.html, audit-trail.html.
...
- The other 313 tokens are declared non-claims — citation years,
