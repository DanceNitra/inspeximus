...
| 2 | `MCP_LISTINGS.md` | `102` | The MCP server exposes 102 tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
| 3 | `MCP_LISTINGS.md` | `102` | The enumerated tool list matches the server | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
...
| 21 | `README.md` | `102` | The MCP server exposes 102 tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
...
| 39 | `claude-code.html` | `102` | The MCP server exposes 102 tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
...
| 71 | `docs/DEEP_DIVE.md` | `102` | The MCP server exposes 102 tools | **REPRODUCIBLE** | `python -c "import re,pathlib;print(len(re.findall(chr(64)+chr(109)+chr(99)+chr(112)+chr(46)+'tool', pathlib.Path('inspeximus/mcp_server.py').read_text(encoding='utf-8'))))"` |
...
| 122 | `index.html` | `102` `0` | Homepage counter: 102 MCP tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
| 123 | `index.html` | `102` | Homepage heading: 102 MCP tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
