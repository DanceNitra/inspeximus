...
| 14 | `README.md` | `73` | The MCP server exposes 73 tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
...
| 19 | `claude-code.html` | `73` | The MCP server exposes 73 tools | **REPRODUCIBLE** | `python claims_audit.py --numbers` |
